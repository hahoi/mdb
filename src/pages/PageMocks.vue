...
export default {
      ...
      for (let i = 0; i < 5000; i++) {
        ...
        let photo = Mock.mock({
          "array|1": [
            ...
            "https://cdn.quasar.dev/img/image-2x.png",
  ...
  //         ],
  //       });
  //       console.log(id, professionalTitle.array);
  //       dbFirestore.collection("現場紀錄表").doc(id.id).update({
