<template>
  <q-page style="max-width: 600px; margin: auto">
    <q-card class="rounded-borders q-ma-md bg-grey-1">
      <q-card-section>
    ...
    <template v-else>
      <div class="q-mt-xl q-pt-xl " ref="showRecord">
        <show-record20201012></show-record20201012>
      </div>
    </template>
  </q-page>
</template>
...
export default {
  ...
  components: {
    ShowRecord20201012: require("components/ShowRecord20201012.vue").default,
  },
  created() {
    //讀入分類
  ...
  computed: {
    ...
    ...mapState("phrase", ["professionalTitle", "counties"]),
