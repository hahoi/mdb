  ...
  <q-page class="bg-cyan-1" style="max-width: 600px; margin: auto">
    <q-form ref="form" @submit.prevent="onSubmit" @reset="onReset">
      ...
      <div class="bg-cyan" v-if="dialogTab">
        ...
        <q-tab-panels v-model="tab" animated class="bg-cyan-1">
          <q-tab-panel name="information" class="col">
            ...
            <div class="q-ma-md row items-start col-10">
              <q-select
                class="col"
          ...
          <q-tab-panel name="other">
            ...
            <div class="q-gutter-md q-ma-md row items-start">
              ...
              />
              <div class="col-2">
                <q-toggle v-model="data.RedDot" color="red" />
              </div>
            </div>
          </q-tab-panel>
        </q-tab-panels>
...
export default {
  ...
  methods: {
    ...mapMutations("search", ["setCurrentId", "setFieldRecordPhoto"]),
    ...mapActions("search", ["addFieldRecord", "updateFieldRecord"]), //上傳圖片要特處理
