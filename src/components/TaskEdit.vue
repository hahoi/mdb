      ...
      >
        ...
        <q-tab-panels v-model="tab" animated>
          <q-tab-panel name="information">
            ...
            <div class="q-gutter-md row items-start">
              <q-input v-model="task.mobilePhone" label="手機" />
            </div>
            <div class="q-gutter-md row items-start">
            ...
            <div class="q-gutter-md row items-start">
              <q-input v-model="task.personalConnections" label="人脈關係" />
            </div>
          </q-tab-panel>
          <q-tab-panel name="Suggestions">
            <div class="q-gutter-md q-my-md">
              <q-input v-model="task.meetNotes" label="見面記事" autogrow />
            </div>
            <div class="q-gutter-md q-my-md">
              <q-input v-model="task.suggestions" label="建言事項" autogrow />
            </div>
            <div class="q-gutter-md q-my-md">
              <q-input
          ...
          <q-tab-panel name="other">
            <div class="q-gutter-md row items-start">
              <q-input v-model="task.diet" label="飲食" />
            </div>
            <div class="q-gutter-md row items-start">
              <q-input v-model="task.interest" label="興趣" />
            </div>
            <div class="q-gutter-md row items-start">
              <q-input v-model="task.topic" label="話題" />
            </div>
            <div class="q-gutter-md row items-start">
        ...
        uploadTask.on(
          ...
          function () {
            ...
            uploadTask.snapshot.ref.getDownloadURL().then((downloadURL) => {
              ...
              vm.task.photo.push(data);
              console.log(vm.task.photo);

              // 存入照片資料
              let payload = {
                id: vm.id,
                data: {
                  avatar: vm.task.photo[0].linkURL,
                  photo: vm.task.photo,
                },
              };
              //跳下一步
