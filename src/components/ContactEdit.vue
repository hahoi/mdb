<template>
  <div class="bg-white" style="max-width: 600px; margin: auto" v-if="dialogTab">
    <q-form ref="form" @submit.prevent="onSubmit" @reset="onReset">
      <q-tabs
        v-model="tab"
        class="text-grey text-caption bg-deep-purple-10"
        active-color="white"
      ...
      <q-tab-panels v-model="tab" animated>
        ...
        <q-tab-panel name="other">
          ...
          <div class="q-gutter-md q-ma-md row items-start">
            <q-rating v-model="task.star" size="2em" :max="5" color="primary" />

            <q-toggle v-model="task.RedDot" color="red" class="col-2" />
          </div>
        </q-tab-panel>
...
export default {
  ...
  methods: {
    ...
    ...mapActions("search", ["updateFieldRecord"]),
